...
function BusinessPayAftaScreen({ navigation }) {  
                ...
                <LinearGradient 
                    ...
                    <View style={styles.cardBody2}>
                        <View style={styles.leftTextCon}> 
                            <Text style={styles.leftTextConH6}>Business PayAfta</Text>
                        </View> 
                    </View>
                </LinearGradient>   
            </TouchableOpacity>
            <View style={styles.body}>
                <View style={{ justifyContent: 'space-between', alignItems: 'center' }}> 
                        ...
                        <TouchableOpacity
                          style={styles.card} onPress={() =>  setUpdateAllShows(!updateAllShows) }>
                            <View style={styles.cardBody}>
                                ...
                                <View>
                                    <View style={[styles.cardButton, { backgroundColor: '#404CB2' }]}>
                            ...
                            </View>
                            {
                                ...
                                <View style={styles.transactionList}>  
                                    ...
                                    <View style={styles.transactionListElement}>
                                        ...
                                        <View style={[styles.cardButton, { backgroundColor: '#243972' }]}>
                                            <Text style={styles.cardButtonText}>Not Paid</Text>
                                        </View>
                                    </View>  
                                    <View style={styles.transactionListElement}>
                                        <View>
                    ...
                    <View style={{ marginBottom: '20%' }}>
                        <TouchableOpacity style={[styles.bottomButton, { backgroundColor: '#243972' }]} onPress={() => setModalVisible(!modalVisible)}>
                            <Text style={[styles.bottomButtonText, { color: '#FFF' }]}>CREATE BUSINESS PAY AFTA</Text>
                        </TouchableOpacity> 
            ...
            <Modal
              ...
              <View style={styles.modalContainer}>
                  <View style={styles.slideContainer}>
                      <LinearGradient colors={['#243972', '#243972']} style={styles.selectContainer}>
                          <Ionicons name="remove-outline" size={30} color="#FFFFFFB8" onPress={() => setModalVisible(!modalVisible)} />
                          <Text style={styles.modalTitle}>Create PAY AFTA</Text>
                      </LinearGradient>
                        ...
                        <View style={{ width: width - 40, marginTop: 10 }} showsVerticalScrollIndicator={false}> 
                            {
                                ...
                                <> 
                                    ...
                                    <View style={{ marginTop: 15 }}>
                                        <Text style={styles.formLabel}>Pay Afta Type</Text>
                                        <TextInput
                                            // label="Email"
                                            value={selection.amount}
                                            mode={'outlined'}
                                            placeholder={'Better Pay Afta'}
                                            onChangeText={text => setSelection(text)}
                                            style={styles.input}
                                        />
                                    </View>
                                    <Text style={{ color: '#94AFB6', fontSize: 10, textAlign: 'left', top: 5 }}>I agree with Terms and Conditions</Text>
                                    <View>
            ...
            <Modal
              ...
              <View style={styles.modalContainer}>
                  <View style={[styles.slideContainer, { height: 300 }]}>
                      <LinearGradient colors={['#243972', '#14234A']} style={styles.selectContainer}>
...
export default BusinessPayAftaScreen; 
