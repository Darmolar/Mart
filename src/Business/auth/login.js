...
function BusinessSignInScreen({ navigation }) {
        ...
        <View style={styles.body}>
          ...
          <View style={styles.footer}>
            <View style={styles.selectFooter}>
              <Pressable onPress={() => navigation.navigate('Login')} style={[styles.selectCard, { borderBottomRightRadius: 20, backgroundColor: '#FFF'  }]}>
                <View>
                  <Feather name="user" size={30} color="#243972" /> 
                </View>
                <View>
                  <Text style={[styles.selectText, { color: '#243972' }]}>Personal</Text>
                  <Text style={[styles.selectText, { color: '#243972' }]}>Account</Text>
                </View>
              </Pressable>
              <Pressable onPress={() => navigation.navigate('BusinessSignIn')} style={[styles.selectCard, {  borderBottomLeftRadius: 20, borderWidth: 0, }]}>
                <View>
                  <Feather name="user" size={30} color="#fff"  />
                </View>
                <View>
                  <Text style={[styles.selectText, ]}>Business</Text>
