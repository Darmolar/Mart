        ...
        <TouchableOpacity style={[styles.viewContainer, ]}>
            <LinearGradient colors={['#192841', '#192841']} style={styles.cardContainer} >
                <View style={styles.cardBody}>
                    <View style={styles.leftTextCon}> 
                        <Text style={styles.leftTextConH6}>Next Of Kin</Text>
                    </View> 
                </View>
            </LinearGradient>
        </TouchableOpacity> 
         <View style={styles.body}>
            <View style={styles.cardView}>
                <Text style={styles.cardViewText}>Next Of Kin Info</Text>
                  <ScrollView style={{ width: '100%', marginTop: 20, }} showsVerticalScrollIndicator={false}> 
                    ...
                    <View style={{ marginTop: 20 }}>  
                        {/* <Text style={styles.formLabel}>Confirm BVN</Text> */}
                        <View style={{ flexDirection: 'row',   fontSize: 12, borderColor: '#E5E5E5',  paddingLeft: 20, borderWidth: 1, backgroundColor: '#F9F9F9', height: 40, borderRadius: 40,  }}>
                            <View style={{ width: '15%', height: '100%', justifyContent: 'center', alignItems: 'flex-start' }}>
                                <AntDesign name="link" size={25} color="#000" />
                            </View>
                            <TextInput
                                // label="Email"
                                value={selection.amount} 
                                placeholder={'File'}
                                onChangeText={text => setSelection(text)}
                                style={{ fontSize: 12, width: '70%', fontSize: 18, paddingLeft: 20, height: '100%', height: 40, justifyContent: 'center', alignItems: 'center' }}
                                />
                            <View style={{ width: '15%', height: '100%', justifyContent: 'center', alignItems: 'center', backgroundColor: '#14234A', borderRadius: 100 }}>
