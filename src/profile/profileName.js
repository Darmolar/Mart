              ...
              <LinearGradient colors={['#192841', '#192841']} style={styles.cardContainer} >
                  <View style={styles.cardBody}>
                      <View style={styles.leftTextCon}> 
                          <Text style={styles.leftTextConH6}>Edit Name</Text>
                      </View> 
                  </View>
              </LinearGradient>
          </TouchableOpacity> 
         <View style={styles.body}>
            <ScrollView style={{ width: width - 40 }} showsVerticalScrollIndicator={false}> 
                <View style={{ marginTop: 15 }}> 
                    <Text style={styles.formLabel}>Edit Full Name</Text>
                    <TextInput
                          // label="Email"
                          ...
                          style={{ fontSize: 12, paddingLeft: 20, marginTop: 5, borderWidth: 1, backgroundColor: '#fff', height: 40, borderRadius: 40, }}
                        />
                </View>  
                <View style={{ marginTop: 20 }}>  
                    <Text style={styles.formLabel}>Edit Username</Text>
                    <TextInput
                          // label="Email"
                          value={selection.amount}
                          mode={'outlined'}
                          placeholder={'MarrtinzDesigns'}
                          onChangeText={text => setSelection(text)}
                          style={{ fontSize: 12, paddingLeft: 20, marginTop: 5, borderWidth: 1, backgroundColor: '#fff', height: 40, borderRadius: 40, }}
                        />
                </View>    
